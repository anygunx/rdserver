 ...
 */
public class PayCumulateFixedEvent1 implements IActivityEvent {

    private static Logger logger = Logger.getLogger(PayCumulateFixedEvent1.class);

    private int activityId;

    public PayCumulateFixedEvent1(int id) {
        this.activityId = id;
    }
