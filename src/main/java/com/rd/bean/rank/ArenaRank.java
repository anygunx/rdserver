 ...
 */
public class ArenaRank extends SimplePlayer implements Comparable<ArenaRank> {
    ...
    @Override
    public int compareTo(ArenaRank o) {
        if (value > o.getValue())
            return -1;
    ...
    public static ArenaRank createWithString(ERankType rankType, String str) {
